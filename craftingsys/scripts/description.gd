...
func _process(delta: float) -> void:
	...
	if item == "old_boots":
		...
		text = "[color=#4a3b16][font_size=9]Clover ( $100 )[/font_size]\n[font_size=8]Provides Luckier Shop Items[/font_size][/color]"
		...
		text = "[color=#4a3b16][font_size=9]Old Bundle ( $40 )[/font_size]\n[font_size=7]Expands Storage Even More[/font_size][/color]"
	elif item == "hammer":
